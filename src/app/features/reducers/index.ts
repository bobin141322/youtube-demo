...
export const getCollectionVideoIds = createSelector(getCollectionState, fromCollection.getIds);
export const getVideoCollection = createSelector(getVideoEntities, getCollectionVideoIds, (entities, ids) => {
